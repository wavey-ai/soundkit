...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!(
        "{{\"codec\":\"libopus-rs\",\"sample_rate\":{SAMPLE_RATE},\"channels\":{CHANNELS},\"pcm_bits\":\"{}\",\"frame_size\":{frame_size},\"bitrate\":{bitrate},\"mode\":\"{mode}\",\"packets\":{packet_count},\"packet_bytes\":{packet_bytes},\"packet_min\":{packet_min},\"packet_max\":{packet_max}}}",
        input.label()
    );
    Ok(())
}
