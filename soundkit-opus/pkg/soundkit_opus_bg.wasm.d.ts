...
export const __wbg_decoderesulti24_free: (a: number, b: number) => void;
...
export const decoder_dec_frame_i24: (a: number, b: number, c: number) => [number, number, number];
export const decoder_dec_frame_i24_reuse: (a: number, b: number, c: number) => [number, number, number];
...
export const decoder_outputI24Len: (a: number) => number;
export const decoder_outputI24Ptr: (a: number) => number;
...
export const decoderesulti24_output: (a: number) => [number, number];
export const encoder_destroy: (a: number) => void;
export const encoder_enc_frame: (a: number, b: number, c: number) => [number, number, number];
export const encoder_enc_frame_i24: (a: number, b: number, c: number) => [number, number, number];
export const encoder_enc_frame_i24_reuse: (a: number) => [number, number, number];
export const encoder_enc_frame_reuse: (a: number) => [number, number, number];
export const encoder_inputI24Len: (a: number) => number;
export const encoder_inputI24Ptr: (a: number) => number;
export const encoder_inputLen: (a: number) => number;
export const encoder_inputPtr: (a: number) => number;
export const encoder_new: (a: number, b: number, c: number, d: number) => [number, number, number];
export const encoder_outputLen: (a: number) => number;
export const encoder_outputPtr: (a: number) => number;
...
export const decoderesulti24_decodedSize: (a: number) => number;
