use soundkit_opus::celt::cwrs::get_pulses;
use soundkit_opus::celt::entropy::RangeEncoder;
use soundkit_opus::celt::modes::{bits2pulses, pulses2bits, CeltMode};
use soundkit_opus::celt::vq::{
